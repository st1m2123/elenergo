...
//         text: [
//             "ООО «Элэнерго» предлагает услугу Электроснабжение “под ключ”, которая позволит Вам осуществить все необходимые действия по технологическому присоединению к энергоснабжающим устройствам быстро и качественно. Энергоснабжение «под ключ» включает: Выбор сетевой организации к сетям которой оптимально произвести подключение, подача заявки на технологическое присоединение;Получение договора о технологическом присоединении и технических условий;Проектирование любой сложности, в том числе:сетей внутреннего электроснабжения 0,4 кВ, внутриплощадочных сетей;внешнего электроснабжения: кабельных линий (КЛ); воздушных линий (ВЛ, ВЛЗ, ВЛИ); трансформаторных подстанций (КТП, ТП, РТП, РП) – 6(10) кВ;Согласование проектных работ в необходимых инстанциях, с собственниками земель, органами власти, Ростехнадзором;Согласование проекта с сетевой организацией;Проведение строительно-монтажных работ и электро-испытаний с выдачей протоколов, сдача объекта в эксплуатацию.Срок и стоимость оказания каждой услуги определяется индивидуально, в зависимости от объема действий, которые необходимо будет осуществить нашим специалистам."
//         ],
//         textBottom: [],
...
//         text: [
//             "Компания «Элэнерго» разрабатывает проекты электроснабжения следующих объектов:",
...
//         ],
//         textBottom: [
//             'Качественно составленный проект позволит Вам сэкономить денежные средства на стадии строительства и в процессе эксплуатации объекта за счёт выбора оптимального технического решения.',
//             "При подготовке проекта мы получаем от Вас:",
//             "• Техническое задание;",
//             "• Разрешение на присоединение мощности.",
//             "В соответствии с выполненным проектом, мы осуществляем авторский надзор.Готовы пройти экспертизу любого уровня (Коммерческую или Государственную).Возможна постановка вашего объекта на сервитут с прохождением всех необходимых для этого инстанций."
//         ],
//         image: DesignImg,
//         url: '/Design'
//     },
...
//         text: [
//             "Основным видом деятельности ООО «Элэнерго» являются электромонтажные работы в электроустановках напряжением от 0,4 до 10 кВ:",
...
//         "Лаборатория укомплектована переносными приборами и имеет право на проведение измерений, а также эксплуатационных и приемо-сдаточных испытаний электрооборудования до 10 кВ.",
...
//         ],
//         textBottom: [
//             "Кто может проводить техническое обслуживание электроустановки?",
...
//             'Почему Договор на техническое обслуживание с нами выгоден для Заказчика?',
